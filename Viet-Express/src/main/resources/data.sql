...
-- Cột: estimated_time_hours (không phải estimated_hours)
...
-- Cột: capacity_weight, capacity_volume (không phải capacity_kg)
...
(3, 'Phạm Văn Nhân', '0934567890', 'staff1@logistics.vn', 1, true, NOW(), NOW()),
(4, 'Hoàng Thị Mai', '0945678901', 'staff2@logistics.vn', 3, true, NOW(), NOW());

-- 9. SHIPPERS (Tài xế) - FK: user_id, current_location_id
-- Lưu ý: current_trip_id sẽ set sau khi có trips
...
(5, 'Đinh Văn Tài', '0956789012', 'TP.HCM', true, 1, true, NOW(), NOW()),
(6, 'Võ Thị Lan', '0967890123', 'TP.HCM', true, 2, true, NOW(), NOW()),
(7, 'Bùi Văn Hùng', '0978901234', 'Hà Nội', true, 3, true, NOW(), NOW());
...
-- Cột: started_at, ended_at, cod_amount (không phải start_time, end_time, total_cod_collected)
